...
{
	global $l_error;
   $dbi=mysql_connect($host, $user, $password); /* 65536 is used for store procedure. We had a problem at first getting mssql results  text field to return anything more than 4096 bytes.*/ 
