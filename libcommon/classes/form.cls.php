...
class InputForm
{
	...
	function selectNumber($startNumber, $endNumber, $inputName, $titleName, $comparedVal='', $order='asc', $htmlid='')
	{
		if($order == "desc") 
		{
			print "<select  name='".$inputName."' id='$htmlid' style=\"width:100px;\"><option value=''>".$titleName."</option>";
		...
		{
			print "<select id='$htmlid' name='".$inputName."' style=\"width:100px;\"><option value=''>".$titleName."</option>";
	...
	function selectField($inputName, $titleName, $fieldSelectID, $fieldSelectName, $tableName, $fieldRef='', $fieldValue='', $comparedVal='', $htmlid='',$width="150")
	{

		print "<select id='$htmlid' name='".$inputName."' style='width:".$width."px'><option value=''>".$titleName."</option>";
